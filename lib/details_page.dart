                  ...
                  child: ListView(children: [
                    ...
                    Container(
                        ...
                        child: ListView(
                            ...
                            buildIngredientItem(
                            'water',
                            Icon(FeatherIcons.droplet,size: 10.0,
                            color: Colors.white,
                            ), Color(0xFF6FC5DA)  ),
                             buildIngredientItem(
                            'Brewed Espresso',
                            Icon(FeatherIcons.target,size: 18.0,
                            color: Colors.white,
                            ), Color(0xFF615955)  ),
                              buildIngredientItem(
                            'Suger ',
                            Icon(FeatherIcons.box,size: 18.0,
                            color: Colors.white,
                            ), Color(0xFFF39595)  ),
                              buildIngredientItem(
                              'Toffee Nut Syrup',
                              Icon(MdiIcons.peanutOutline, size: 18.0, color: Colors.white),
                              Color(0xFF8FC28A),
                            ),
                            buildIngredientItem(
                              'Natural Flavors',
                              Icon(MdiIcons.leafMaple, size: 18.0, color: Colors.white),
                              Color(0xFF3B8079),
                            ),
                            buildIngredientItem(
                              'Vanilla Syrup',
                              Icon(MdiIcons.flowerTulipOutline, size: 18.0, color: Colors.white),
                              Color(0xFFF8B870),
                            ),
                            SizedBox(width: 25.0)
                                    ...
                                    children: [
                                     ...
                                     Container(
                                      ...
                                      decoration: BoxDecoration(
                                        borderRadius: BorderRadius.circular(17.5),
                                        image: DecorationImage(
                                          image: AssetImage('assets/model2.png'),
                                          fit: BoxFit.cover
                                        ),
                                        border: Border.all(
                                        color: Color(0xFFF3B2B7),
